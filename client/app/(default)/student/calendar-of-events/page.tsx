...
export default function CalendarOfEventsPage() {
  ...
  const loadAppointments = async () => {
    try {
      ...
      const apts = await getStudentAppointments()
              ...
              {!status?.connected ? (
                <div className="space-y-4">
                  <p className="text-muted-foreground text-sm">
                    ...
                    appointments. When you book or update an appointment, it
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4">
                    <p className="text-muted-foreground text-sm">
                      <strong>How it works:</strong> When you book an
                      appointment, it automatically appears in your Google
                      Calendar. If you cancel or reschedule, your calendar
