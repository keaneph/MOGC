...
const SecondStepCard = ({
  ...
  return (
    <Card className="relative w-[350px] tracking-wide">
      <button
        onClick={skipTour}
        className="text-main2/70 hover:text-main2/100 absolute top-4 right-4"
        aria-label="Close"
      >
      ...
      <div className="px-6">
        ...
        <div className="-mb-2 flex flex-col gap-12">
          ...
          <button
            onClick={skipTour}
            className="text-link w-full cursor-pointer text-left text-sm decoration-2 underline-offset-4 hover:underline"
          >
            Maybe later
          </button>
        </div>
