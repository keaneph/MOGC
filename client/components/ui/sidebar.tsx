  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative inset-y-0 z-10 hidden h-[calc(100svh-3.5rem)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
